...
wrench"): example_wrench_coarse.py, wrench_validation.py, wrench_refined.py.
"""
...
from example_wrench_coarse_utils import WrenchGeometry
...
# ~1e-1 with the [0.1, 0.9]^4 box used in example_wrench_coarse.py).
ROM_MDEIM_N = 2
ROM_MDEIM_P = 6
